...
class AcitivyList:
    ...
    def initialize_me(self):
        """
        Loading data from json file in disks to memory.
        Please put the json file under project root dir.

        :return: A list of Activity items.
        """
        activity_list = None
...
class Activity:
    """
    Describe information of an activity, which is a window or a web.
    """
